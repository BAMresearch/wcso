 ...
 * [wcso.yml](wcso.yml)
     * Determines how your purl.obolibrary.org/obo/wcso/ redirects will be handled
     ...
     * Paste in the contents of [wcso.yml](wcso.yml)
 ...
 * [wcso.md](wcso.md)
     ...
     * Paste in the contents of [wcso.md](wcso.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
