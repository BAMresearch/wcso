...
Here you can find the [Issue tracker](https://github.com/BAMresearch/wcso/issues).

### How It Works  

1. **Access the Repository Issue Tracker**  
   Visit the [Issue tracker](https://github.com/BAMresearch/wcso/issues) of our GitHub repository in which the ontology project is hosted. 
