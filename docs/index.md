...
This documentation is designed to guide you through the ontology's structure, features, and applications, making it easier to understand and use the ontology. Whether you're a researcher, developer, or industry professional, we're excited to support your journey towards smarter, more efficient materials science practices and we are eager to get in contact with you.

### Prefix and namespace
- Namespace: [https://w3id.org/wcso](https://w3id.org/wcso)
- Prefix: wcso
